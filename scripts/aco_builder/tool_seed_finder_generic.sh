...
#
#    Seed finder for bel_projects
#    Do seed sweeping for the given repo branch/tag and target of bel_projects.
#    For the given target a certain number of syntheses are done (in parallel).
#    On successful completion of the synthesis, its timing report file is scanned for the critical timing warnings and the worst-case slack values.
#    The scan result is stored in in log file, seed_finder.log, and is sent per email to the given users.
#
# - Discard old builds (checked)
#
# - This project is parameterized (checked)
# --> String Parameter 
#     Name = PAR_BEL_BRANCH, Default Value = enigma, Description = Available branches: enigma, enigma_quartus18, master
# --> String Parameter 
#     Name = PAR_BEL_TARGET, Default Value = scu3, Description = Available targets: scu2, scu3, vetar2a, vetar2a-ee-butis, exploder5, pexarria5, microtca, pmc
# --> String Parameter 
#     Name = PAR_QUARTUS_VERSION, Default Value = 18, Description = Supported versions: 18
# --> String Parameter 
#     Name = PAR_MAX_COUNT, Default Value = 4, Description = Seed sweep with more than 10 seed values is generally not required according to AN 584 [Timing Closure Methodology].
#
...
export CFG_QUARTUS_VERSION=$PAR_QUARTUS_VERSION # 18
export CFG_BRANCH=$PAR_BEL_BRANCH # enigma, doomsday, master, ...
export CFG_TARGET=$PAR_BEL_TARGET # scu2, scu3, vetar2a, vetar2a-ee-butis, exploder5, pexarria5, microtca, pmc
export CFG_ALL_TARGETS=($PAR_BEL_TARGET)
...
export MAX_COUNT=$PAR_MAX_COUNT                # total number of seed values
